...
for  i in range(4):
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.0.weight'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.self.query.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.0.bias'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.self.query.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.1.weight'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.self.key.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.1.bias'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.self.key.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.2.weight'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.self.value.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.2.bias']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.self.value.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.3.weight']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.output.dense.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.3.bias'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.output.dense.bias'] 
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear1.weight']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.intermediate.dense.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear1.bias']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.intermediate.dense.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear2.weight']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.output.dense.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear2.bias']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.output.dense.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm1.weight']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.output.LayerNorm.gamma']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm1.bias']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.attention.output.LayerNorm.beta']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm2.weight']  = bert_weight['bert.encoder.layer.'+str(i+8)+'.output.LayerNorm.gamma']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm2.bias'] = bert_weight['bert.encoder.layer.'+str(i+8)+'.output.LayerNorm.beta']
...
torch.save(opt_weight,'./output/pretrianed_weights/double_modify_timesformerbase16_bertbaseuncased_timezero_8_12_4.pt')
