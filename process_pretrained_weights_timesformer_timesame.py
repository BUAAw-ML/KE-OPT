...
for  i in range(12):
    ...
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.0.weight'] = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/query/kernel']).reshape(768,-1).permute(1,0)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.0.bias'] = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/query/bias']).reshape(768)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.1.weight'] = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/key/kernel']).reshape(768,-1).permute(1,0)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.1.bias'] = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/key/bias']).reshape(768)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.2.weight'] = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/value/kernel']).reshape(768,-1).permute(1,0)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.2.bias']  = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/value/bias']).reshape(768)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.3.weight']  = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/out/kernel']).reshape(-1,768).permute(1,0)
    opt_weight['opt.video_encoder.layer.'+str(i)+'.attention_time.linears.3.bias'] = trans(vit_weight['Transformer/encoderblock_'+str(i)+'/MultiHeadDotProductAttention_1/out/bias'])
...
torch.save(opt_weight,'./output/pretrianed_weights/double_modify_timesformerbase32_bertbaseuncased_timesame.pt')
