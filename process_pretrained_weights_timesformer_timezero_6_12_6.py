...
for  i in range(6):
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.0.weight'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.self.query.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.0.bias'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.self.query.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.1.weight'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.self.key.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.1.bias'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.self.key.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.2.weight'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.self.value.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.2.bias']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.self.value.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.3.weight']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.output.dense.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.attention.linears.3.bias'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.output.dense.bias'] 
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear1.weight']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.intermediate.dense.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear1.bias']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.intermediate.dense.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear2.weight']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.output.dense.weight']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.ff_layer.linear2.bias']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.output.dense.bias']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm1.weight']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.output.LayerNorm.gamma']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm1.bias']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.attention.output.LayerNorm.beta']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm2.weight']  = bert_weight['bert.encoder.layer.'+str(i+6)+'.output.LayerNorm.gamma']
    opt_weight['opt.multimodal_encoder.layer.'+str(i)+'.layernorm2.bias'] = bert_weight['bert.encoder.layer.'+str(i+6)+'.output.LayerNorm.beta']
...
torch.save(opt_weight,'./output/pretrianed_weights/double_modify_timesformerbase16_bertbaseuncased_timezero_6_12_6.pt')
