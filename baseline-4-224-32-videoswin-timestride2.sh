basedir="./output/v2.0_double_modify_new_baseline_4_224_32_videoswin-timestride2_1"
...
--config ./config/caption-msrvtt-b64-lr5e-5-2witer-mlm0.6.json \
...
CUDA_VISIBLE_DEVICES=2 horovodrun -np 1 python ./train_open_ended_vqa.py \
--config ./config/VQA-msrvtt-b64-lr5e-5-2witer-answerfull.json \
