basedir="./output/v2.0_double_modify_new_baseline_4_224_32_vit_local_singlemodality_deep"
...
CUDA_VISIBLE_DEVICES=5 horovodrun -np 1 python ./train_fast_retrieval.py \
